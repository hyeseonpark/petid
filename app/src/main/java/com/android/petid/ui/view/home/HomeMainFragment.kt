...
class HomeMainFragment : Fragment() {
    ...
    private fun initBanner(bannerList: List<BannerEntity>) {
        //banner
        // val bannerList = arrayListOf<BannerEntity>()


        viewModel.getBannerImage("bannerImage\\/darthVader.jpg")
...
//        val dummyImageUrl3 = "data:image/jpeg;base64,"
        ...
        // bannerList.add(BannerItem(R.drawable.img_banner_1))
        // bannerList.add(BannerItem(R.drawable.img_banner_2))
        ...
        binding.viewPagerLifeStyle1.orientation = ViewPager2.ORIENTATION_HORIZONTAL
        binding.viewPagerLifeStyle1.adapter = bannerAdapter
        binding.viewPagerLifeStyle1.setCurrentItem(bannerPosition, false) //시작 위치 지정

        binding.viewPagerLifeStyle1.apply {
    ...
    private inner class HomeBannerHandler: Handler(Looper.getMainLooper()) {
        override fun handleMessage(msg: Message) {
            ...
            if(msg.what == 0){
                binding.viewPagerLifeStyle1.setCurrentItem(++bannerPosition, true) //다음 페이지로 이동
    ...
    private fun setupImageObservers() {
        lifecycleScope.launch {
            viewModel.bannerImageApiState.collectLatest { result ->
                when (result) {
                    is CommonApiState.Success -> {
