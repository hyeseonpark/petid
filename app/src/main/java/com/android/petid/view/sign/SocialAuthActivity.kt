...
//        startActivity(intentIntro)
    ...
    private fun initComponent() {
        binding.textViewSubtitle.text =
            setStyleSpan(
                applicationContext,
                binding.textViewSubtitle.text.toString(),
                resources.getString(R.string.social_auth_acitivity_sub_title_span),
                R.color.petid_clear_blue
            )
...
//                    Toast.makeText(this, "Firebase 인증에 실패했습니다.", Toast.LENGTH_SHORT).show()
     ...
     * 이용약관 동의 페이지로 이동
     */
    private fun goPermissionActivity() {
